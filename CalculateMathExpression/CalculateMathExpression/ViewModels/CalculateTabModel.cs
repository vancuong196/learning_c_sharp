...
{
    public class CalculateTabModel : ViewModelBase
    {
        ...
        public CalculateTabModel()
        {
            _messageService = new MessageService();
            SavedXFormula = (new ViewModelLocator()).Main.SavedXFormula;
            SavedYFormula = (new ViewModelLocator()).Main.SavedYFormula;
