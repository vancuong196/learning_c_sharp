...
namespace Task_Manager_Prism.DatabaseAccess
{
    public class DummyDatabaseAccessService : IDatabaseAccessService
    {
        public Task<List<TaskItem>> GetTasks()
        {
            ...
            taskList.Add(new TaskItem(3,"Test3", "12:30", "25/12/2018", "Descrition12", true, "Home"));
            taskList.Add(new TaskItem(5,"Test4", "12:30", "21/11/2018", "Descrition13", true, "School",true));
            taskList.Add(new TaskItem(6,"Test5", "12:30", "24/12/2018", "Descrition14", true, "School"));
            taskList.Add(new TaskItem(7,"Test6", "12:30", "24/11/2018", "Descrition15", false, "Work",true));
            ...
            taskList.Add(new TaskItem(10,"Test9", "12:30", "24/12/2018", "Descrition18", true, "Work"));
        ...
        public Task<List<TagItem>> GetTags()
        {
            ...
            tagList.Add(new TagItem("Home"));
            tagList.Add(new TagItem("School"));
            tagList.Add(new TagItem("Work"));
