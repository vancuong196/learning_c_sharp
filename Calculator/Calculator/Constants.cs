...
namespace CalculatorApplicaiton
{
    public class Constants
    {
        ...
        public const string Hint = "KEY HINT: esc:Reset | m:MR | p:M+ | s:M- | c:MC | l:MS | n:+/- | i:1/x | r:sqrt | enter:= | backspace | h:history | <:previous | >:next";
        public const int EnterKeyCode = 13;
        public const int NavigationUpKeyCode = '<';
        public const int NavigationDownKeyCode = '>';
